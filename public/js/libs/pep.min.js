...
! function(a, b) {
    ...
    function a(a, b) {
        ...
        return f = b.pressure && c.buttons ? b.pressure : c.buttons ? .5 : 0, c.x = c.clientX, c.y = c.clientY, c.pointerId = b.pointerId || 0, c.width = b.width || 0, c.height = b.height || 0, c.pressure = f, c.tiltX = b.tiltX || 0, c.tiltY = b.tiltY || 0, c.pointerType = b.pointerType || "", c.hwTimestamp = b.hwTimestamp || 0, c.isPrimary = b.isPrimary || !1, c
    }
    ...
    function h() {
        ...
        if (!window.PointerEvent) {
            ...
            } else u.registerSource("mouse", N), void 0 !== window.ontouchstart && u.registerSource("touch", V);
            u.register(document)
        }
    }
    ...
    function j(a) {
        if (!a.ownerDocument.contains(a)) {
            var b = new Error("InvalidStateError");
            throw b.name = "InvalidStateError", b
        }
    }
    ...
    var q = [
        ...
        u = {
            ...
            contains: /*scope.external.contains || */ function(a, b) {
                try {
                    return a.contains(b)
                } catch (c) {
            ...
            addEvent: /*scope.external.addEvent || */ function(a, b) {
                a.addEventListener(b, this.boundHandler)
            },
            removeEvent: /*scope.external.removeEvent || */ function(a, b) {
            ...
            cloneEvent: function(a) {
                for (var b, c = Object.create(null), d = 0; d < q.length; d++) b = q[d], c[b] = a[b] || r[d],
            ...
            propagate: function(a, b, c) {
                for (var d = a.target, e = []; !d.contains(a.relatedTarget) && d !== document;) e.push(d), d = d.parentNode;
                c && e.reverse(), e.forEach(function(c) {
                    a.target = c, b.call(this, a)
                }, this)
            },
            setCapture: function(b, c) {
                this.captureInfo[b] && this.releaseCapture(b), this.captureInfo[b] = c;
                var d = new a("gotpointercapture");
                d.pointerId = b, this.implicitRelease = this.releaseCapture.bind(this, b), document.addEventListener("pointerup", this.implicitRelease), document.addEventListener("pointercancel", this.implicitRelease), d._target = c, this.asyncDispatchEvent(d)
            },
            releaseCapture: function(b) {
                var c = this.captureInfo[b];
                if (c) {
                    var d = new a("lostpointercapture");
                    d.pointerId = b, this.captureInfo[b] = void 0, document.removeEventListener("pointerup", this.implicitRelease), document.removeEventListener("pointercancel", this.implicitRelease), d._target = c, this.asyncDispatchEvent(d)
                }
            },
            /**
    ...
    var M, N = {
        ...
        V = {
            ...
            touchToPointer: function(a) {
                ...
                c.target = O[d] || P(c), c.bubbles = !0, c.cancelable = !0, c.detail = this.clickCount, c.button = 0, c.buttons = this.typeToButtons(b.type), c.width = a.radiusX || a.webkitRadiusX || 0, c.height = a.radiusY || a.webkitRadiusY || 0, c.pressure = a.force || a.webkitForce || .5, c.isPrimary = this.isPrimaryTouch(a), c.pointerType = this.POINTER_TYPE,
    ...
    var W, X, Y = u.pointermap,
        ...
        $ = {
            ...
            prepareEvent: function(a) {
                var b = a;
                return Z && (b = u.cloneEvent(a), b.pointerType = this.POINTER_TYPES[a.pointerType]), b
            },
            cleanup: function(a) {
                Y["delete"](a)
            },
        ...
        _ = window.navigator;
    _.msPointerEnabled ? (W = function(a) {
        i(a), j(this), k(a) && this.msSetPointerCapture(a)
    }, X = function(a) {
        i(a), this.msReleasePointerCapture(a)
    }) : (W = function(a) {
        i(a), j(this), k(a) && u.setCapture(a, this)
    }, X = function(a) {
        i(a), u.releaseCapture(a, this)
    }), g(), h(), l();
    var aa = {
        dispatcher: u,
        Installer: c,
